  ...
  return (
    <main className="min-h-screen bg-[#f8fafc]">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-amber-50/40 blur-[120px]"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-orange-50/40 blur-[120px]"></div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              <div className="w-9 h-9 bg-gradient-to-br from-[#c9a227] to-[#f0d78c] rounded-xl flex items-center justify-center text-[#1a1a1d] font-bold shadow-sm shadow-amber-200/50">A</div>
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#how-it-works" className="text-slate-600 hover:text-[#c9a227] text-sm font-medium transition-colors">Process</a>
              <a href="#features" className="text-slate-600 hover:text-[#c9a227] text-sm font-medium transition-colors">Features</a>
              <a href="#pricing" className="text-slate-600 hover:text-[#c9a227] text-sm font-medium transition-colors">Pricing</a>
              <a href="#activity" className="text-slate-600 hover:text-[#c9a227] text-sm font-medium transition-colors">Live Activity</a>
              <div className="h-6 w-px bg-slate-200 mx-2"></div>
              <button
                onClick={openLogin}
                className="px-6 py-2.5 bg-[#1a1a1d] hover:bg-slate-800 text-white text-sm font-semibold rounded-xl transition-all shadow-md shadow-slate-200 hover:shadow-lg active:scale-95 border border-white/10"
              >
                Sign In
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto z-10 relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-fade-in-up">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-slate-900 mb-8 leading-[1.05] tracking-tight">
                Trade Smarter with
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#c9a227] via-amber-500 to-orange-500"> Automation</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={openLogin}
                  className="px-10 py-5 bg-gradient-to-r from-[#c9a227] to-amber-500 hover:from-amber-500 hover:to-[#c9a227] text-white font-bold rounded-2xl text-lg shadow-xl shadow-amber-200/60 transition-all active:scale-95 hover:translate-y-[-2px] border border-white/20"
                >
            ...
            <div className="relative group animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              {/* Decorative blobs */}
              <div className="absolute -top-10 -right-10 w-32 h-32 bg-amber-200 rounded-full blur-3xl opacity-30 group-hover:opacity-50 transition-opacity"></div>
              <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-orange-200 rounded-full blur-3xl opacity-30 group-hover:opacity-50 transition-opacity"></div>

              <div className="relative bg-white/60 backdrop-blur-3xl border border-white/50 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.06)] overflow-hidden">
                  ...
                  {isLoading ? (
                    ...
                    <>
                      <div className="grid grid-cols-2 gap-4 mb-10">
                        <div className="bg-white/80 rounded-3xl p-6 shadow-sm border border-slate-100 hover:border-amber-200 transition-all hover:translate-y-[-2px]">
                          <div className="text-3xl font-black text-slate-900 mb-1">
                            {formatNumber(stats?.totalTrades || 0)}
                          </div>
                          <div className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em]">Total Trades</div>
                        </div>
                        <div className="bg-white/80 rounded-3xl p-6 shadow-sm border border-slate-100 hover:border-amber-200 transition-all hover:translate-y-[-2px]">
                          <div className="text-3xl font-black text-amber-600 mb-1">
                            {stats?.avgWinRate || 0}%
                          </div>
                          <div className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em]">Avg Win Rate</div>
                        </div>
                        <div className="bg-white/80 rounded-3xl p-6 shadow-sm border border-slate-100 hover:border-amber-200 transition-all hover:translate-y-[-2px]">
                          <div className="text-3xl font-black text-slate-900 mb-1">
                            {formatNumber(stats?.totalUsers || 0)}
                          </div>
                          <div className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em]">Active Users</div>
                        </div>
                        <div className="bg-white/80 rounded-3xl p-6 shadow-sm border border-slate-100 hover:border-amber-200 transition-all hover:translate-y-[-2px]">
                          <div className="text-3xl font-black text-amber-600 mb-1">
                            {stats?.uptime || 99.9}%
                          </div>
                          <div className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em]">Uptime</div>
                        </div>
                      </div>
                      ...
                      <div className="bg-slate-50/50 rounded-[2rem] p-6 border border-slate-100">
                        <div className="flex items-center justify-between mb-5">
                          ...
                          <span className="text-[10px] font-black text-amber-600 hover:underline cursor-pointer">View Feed</span>
                        </div>
                        <div className="space-y-3">
                          {(stats?.recentTrades || []).slice(0, 3).map((trade, idx) => (
                            <div key={idx} className="flex items-center justify-between bg-white/90 p-4 rounded-2xl shadow-sm border border-slate-100/50">
                              <div className="flex items-center gap-3">
                                <div className={`w-9 h-9 rounded-xl flex items-center justify-center text-[10px] font-black ${
                                  trade.type === 'BUY' ? 'bg-green-50 text-green-600' : 'bg-rose-50 text-rose-600'
                                }`}>
                                  {trade.type.charAt(0)}
                                </div>
                                <div>
                                  <div className="text-slate-900 font-black text-sm tracking-tight">{trade.symbol}</div>
      ...
      <section id="how-it-works" className="py-32 px-4 sm:px-6 bg-white relative">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-[#c9a227] text-sm font-black uppercase tracking-[0.3em] mb-4">Onboarding</h2>
            <h3 className="text-4xl sm:text-5xl font-black text-slate-900 mb-6 tracking-tight">Simple. Fast. Reliable.</h3>
            <p className="text-lg text-slate-600 font-medium leading-relaxed">Get your automated trading system up and running in less than 5 minutes with our streamlined process.</p>
          </div>
      ...
      {/* Features Grid */}
      <section id="features" className="py-32 px-4 sm:px-6 bg-[#fcfcfc]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-20">
            <div className="max-w-2xl">
              <h2 className="text-[#c9a227] text-sm font-black uppercase tracking-[0.3em] mb-4">Capability</h2>
              <h3 className="text-4xl sm:text-5xl font-black text-slate-900 tracking-tight">Enterprise Infrastructure. <br/>Made Accessible.</h3>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-white border border-slate-100 rounded-[2rem] p-8 hover:border-amber-200 hover:shadow-[0_20px_40px_rgba(201,162,39,0.04)] transition-all group">
                <div className="w-12 h-12 bg-slate-50 group-hover:bg-amber-50 rounded-2xl flex items-center justify-center text-slate-400 group-hover:text-[#c9a227] transition-colors mb-6">
      ...
      {/* Live Activity Feed */}
      <section id="activity" className="py-32 px-4 sm:px-6 bg-white overflow-hidden relative">
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-[#c9a227] text-sm font-black uppercase tracking-[0.3em] mb-4">Public Ledger</h2>
            <h3 className="text-4xl font-black text-slate-900 mb-4 tracking-tight">Real-Time Performance</h3>
            <p className="text-slate-500 font-medium">Live execution data from the platform ecosystem</p>
          </div>

          <div className="bg-white border border-slate-100 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] overflow-hidden">
            <div className="px-8 py-6 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Active Orders</span>
              <div className="flex items-center gap-2 text-[10px] font-black text-amber-700 bg-amber-50 px-3 py-1.5 rounded-full border border-amber-100/50">
            ...
            <div className="divide-y divide-slate-50">
              {isLoading ? (
                ...
                (stats?.recentTrades || []).map((trade, idx) => (
                  <div key={idx} className="px-8 py-6 flex items-center justify-between hover:bg-amber-50/10 transition-colors">
            ...
            <div className="p-6 bg-slate-50/50 border-t border-slate-50 text-center">
              <button onClick={openLogin} className="text-[#c9a227] font-black text-xs uppercase tracking-widest hover:underline">Connect your account to see full history</button>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-32 px-4 sm:px-6 bg-[#fcfcfc]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-[#c9a227] text-sm font-black uppercase tracking-[0.3em] mb-4">Investment Plans</h2>
            <h3 className="text-4xl sm:text-5xl font-black text-slate-900 mb-6 tracking-tight">Scale Your Strategy</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-10 max-w-6xl mx-auto">
            ...
            {/* Pro Plan - Popular */}
            <div className="bg-[#1a1a1d] border-4 border-amber-500/10 rounded-[2.5rem] p-10 flex flex-col relative shadow-2xl shadow-amber-200/20 transform lg:scale-105 z-10">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 px-6 py-2 bg-gradient-to-r from-[#c9a227] to-amber-500 text-white text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg">
                Recommended
              </div>
              <div className="text-amber-400 text-xs font-black uppercase tracking-[0.25em] mb-6">Professional</div>
              ...
              <button
                onClick={openLogin}
                className="w-full py-4 bg-gradient-to-r from-[#c9a227] to-amber-500 text-white rounded-2xl hover:brightness-110 transition-all font-black uppercase tracking-widest shadow-xl shadow-amber-900/40 active:scale-95 border border-white/20"
              >
                Scale Now
              </button>
            </div>
      ...
      {/* Footer */}
      <footer className="border-t border-slate-100 bg-white pt-24 pb-12 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-20">
            <div className="col-span-2">
              <div className="flex items-center gap-2 mb-6">
                ...
                <div className="text-xl font-bold text-slate-900 tracking-tight">AU<span className="text-[#c9a227]">Next</span></div>
              </div>
