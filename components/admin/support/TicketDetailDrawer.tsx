  ...
  return (
    ...
    >
      <div className="space-y-6">
        {/* User Info */}
        <div className="bg-primary-gold/10 rounded-xl p-4 border border-primary-gold/20">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-gradient-to-r from-primary-gold to-secondary-gold rounded-full flex items-center justify-center text-white font-bold text-lg">
              {ticket.first_name?.[0] || ticket.user_email?.[0]?.toUpperCase() || 'U'}
            </div>
            <div className="flex-1">
              <h3 className="font-bold text-surface-dark">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <h3 className="text-lg font-bold text-surface-dark mb-4 flex items-center gap-2">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-base font-semibold text-surface-dark">{ticket.subject}</p>
            </div>
            <div>
        ...
        <div className="flex gap-3 pt-4 border-t border-gray-200">
          <button
            ...
            className="flex-1 px-4 py-3 bg-gradient-to-r from-primary-gold to-secondary-gold hover:from-secondary-gold hover:to-primary-gold text-surface-dark font-semibold rounded-lg transition-all shadow-md"
          >
            Reply to Ticket
          </button>
          {ticket.status === 'open' && (
