...
export default function BillingContent() {
  return (
    <div className="p-8">
      <div className="mb-10">
        <h3 className="text-xl font-bold text-surface-dark mb-2">Billing & Subscription</h3>
        <p className="text-gray-400 text-sm font-medium">Manage your subscription plan and view payment history.</p>
      </div>

      <div className="space-y-8">
        {/* Current Plan Card */}
        <div className="bg-gradient-to-br from-primary-gold to-secondary-gold rounded-2xl p-8 text-surface-dark shadow-lg shadow-primary-gold/20">
          ...
          <div className="mt-6 pt-6 border-t border-white/20 flex items-center justify-between">
            ...
            <button className="px-5 py-2 bg-surface-dark text-white text-xs font-bold rounded-lg hover:bg-surface-dark/90 transition-colors">
              Manage Auto-renew
            </button>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100 hover:border-secondary-gold transition-all group">
              <div className="flex justify-between items-start mb-6">
                <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-primary-gold shadow-sm border border-primary-gold/20 group-hover:scale-110 transition-transform">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                  </svg>
                </div>
                <div className="text-right">
                  <div className="text-2xl font-black text-surface-dark">$499</div>
                  <div className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">per month</div>
                </div>
              </div>
              <h5 className="font-bold text-surface-dark mb-4">Institutional Premium</h5>
              ...
              <button className="w-full py-3.5 bg-white border border-gray-200 text-surface-dark font-bold text-sm rounded-xl hover:border-primary-gold transition-colors shadow-sm">
                Upgrade Account
              </button>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100 opacity-60">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="text-right">
                  <div className="text-2xl font-black text-surface-dark">$99</div>
                  <div className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">per month</div>
                </div>
              </div>
              <h5 className="font-bold text-surface-dark mb-4">Basic Starter</h5>
              <ul className="space-y-3 mb-8">
              ...
              <tbody className="divide-y divide-gray-50">
                {[
                  ...
                  <tr key={inv.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 font-mono font-bold text-surface-dark">{inv.id}</td>
                    <td className="px-6 py-4 text-gray-500 font-semibold">{inv.date}</td>
                    <td className="px-6 py-4 font-bold text-surface-dark">{inv.amount}</td>
